...
class Transformer:
    ...
    def __init__(self):
        ...
        self.add_rule('Engine & Power','Var',lambda v:split('\d{4}',v)[1].strip())
        self.add_rule('Measurements','Var',lambda v:split('\d{4}',v)[1].strip())
        self.add_rule('Safety Features','Var',lambda v:split('\d{4}',v)[1].strip())
